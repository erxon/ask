...
router.route("/api/answers/list/:questionId").get(answerCtrl.list);

router.route("/api/answers/vote").put(authCtrl.requireSignin, answerCtrl.vote);

router
  .route("/api/answers/unvote")
...
router.route("/api/answers/user/:userId").delete(answerCtrl.removeAll);
